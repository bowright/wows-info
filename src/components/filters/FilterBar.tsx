...
const PRESETS: { id: ColumnPreset; label: string; icon: React.ComponentType<{ className?: string }> }[] = [
  ...
  { id: 'artillery', label: 'Main battery', icon: Crosshair },
  { id: 'ap_shells', label: 'AP shells', icon: Target },
  { id: 'he_shells', label: 'HE shells', icon: Flame },
  { id: 'sap_shells', label: 'SAP shells', icon: CircleDot },
  { id: 'secondary', label: 'Secondaries', icon: Radio },
  { id: 'sonar', label: 'Sonar', icon: Activity },
  { id: 'torpedoes', label: 'Torpedoes', icon: Zap },
  { id: 'aa', label: 'Anti-aircraft', icon: ShieldAlert },
  { id: 'asw', label: 'Depth charges', icon: Layers },
  { id: 'airstrike', label: 'Airstrike', icon: Plane },
  { id: 'attack_aircraft', label: 'Attack aircraft', icon: Rocket },
  { id: 'torpedo_bombers', label: 'Torpedo bombers', icon: Send },
  { id: 'bombers', label: 'Bombers', icon: Bomb },
  { id: 'skip_bombers', label: 'Skip bombers', icon: FastForward },
  { id: 'consumables', label: 'Consumables', icon: Package },
  { id: 'combat_instructions', label: 'Combat instructions', icon: Gauge },
  { id: 'innate', label: 'Innate skills', icon: Award },
