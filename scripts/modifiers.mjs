/**
 * Dynamic Build Modifier Engine for Node.js ESM scripts.
 * Shared implementation of calcModifiedStats(ship, build).
 */

function normalizeUpgradeId(id) {
  if (!id) return '';
 ...
 */
export function calcModifiedStats(ship, build = {}) {
